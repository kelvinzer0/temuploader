...
def main():
    ...
    if args.list:
        ...
        for name, info in providers.items():
            ...
            print(f"{name:<25} {info['max_size_mb']:>8}MB {info['retention']:<12} {binary:>8} {text:>6}")
